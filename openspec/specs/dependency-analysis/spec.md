# Dependency Analysis Spec

## Purpose

The purpose of this capability is to provide comprehensive dependency analysis across various ecosystems using the OSS Review Toolkit (ORT).
